...
public class Profesor extends Persona implements FuncionesPersona {

	public Profesor(int edad, double altura, String nacion, String color, Sexo tipoSexo, double salario,
			double longitud) {
